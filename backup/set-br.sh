...
echo "Checking VPS"
# Link Hosting Kalian
zenhost="raw.githubusercontent.com/fsteamID/InstallerPremiumSSH/main/backup"

apt install rclone -y
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "raw.githubusercontent.com/fsteamID/InstallerPremiumSSH/main/backup/rclone.conf"
