...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/access > /root/tmp
...
# https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/access 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/access | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/access | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/SSH/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/WEBSOCKET/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/OPENVPN/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Install AutoBackup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/MENU/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/version  )
