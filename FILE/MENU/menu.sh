...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/ip/access > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/ip/access | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/ip/access | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/ip/access | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/ip/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/PLUGINS/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/PLUGINS/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/huutvpn/InstallerPremiumSSH/main/FILE/PLUGINS/versi)
if [ "$Isadmin" = "ON" ]; then
